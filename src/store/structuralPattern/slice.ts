...
import {
  ...
  UpdateStructuralPattern,
} from '../../models/StructuralPattern'
...
export const {
  StructuralPatFetchStart,
  StructuralPatFetchFailure,
  StructuralPatsFetchSuccess,
  StructuralPatFetchSuccess,
} = StructuralPatSlice.actions

export const getFetchStructuralPats = () => async (dispatch: any) => {
  dispatch(StructuralPatFetchStart)
  fetchApi
    .GetFetch<StructuralPattern[]>('http://localhost:8008/logtool/structural_pattern')
    .then((res) => {
...
export const getFetchStructuralPat = (id: number) => (dispatch: Dispatch<any>) => {
  dispatch(StructuralPatFetchStart)
  fetchApi
    .GetFetch<StructuralPattern>(`http://localhost:8008/logtool/structural_pattern?params=${id}`)
    .then((res) => {
...
export const createFetchStructuralPat = (data: AddStructuralPattern) => async (dispatch: any) => {
  dispatch(StructuralPatFetchStart)
  fetchApi
    .PostFetch<AddStructuralPattern>('http://localhost:8008/logtool/structural_pattern', data)
    .then(() => {
...
export const updateFetchStructuralPat =
  (data: UpdateStructuralPattern) => async (dispatch: any) => {
    dispatch(StructuralPatFetchStart)
    fetchApi
      .PutFetch<UpdateStructuralPattern>('http://localhost:8008/logtool/structural_pattern', data)
      .then(() => {
        dispatch(getFetchStructuralPats())
      })
      .catch((err) => {
...
export const deleteFetchStructuralPat = (id: number) => async (dispatch: any) => {
  dispatch(StructuralPatFetchStart)
  fetchApi
    .DeleteFetch(`http://localhost:8008/logtool/structural_pattern?params=${id}`)
    .then(() => {
      dispatch(getFetchStructuralPats())
    })
    .catch((err) => {
